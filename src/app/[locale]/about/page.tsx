...
export default function AboutPage() {
  ...
  return <main className="about-page site-palette bg-slate-950 text-white relative">
    ...
    >
      <div className="text-center mb-16">
        <p className="text-sm font-bold uppercase tracking-[0.14em] text-cyan-400 mb-4">
          Dinoora / {ar ? "فريقنا" : "Our Team"}
        </p>
        <h2 className="text-4xl font-black tracking-tight text-white mb-6">
          {ar ? "خبراء في التجارة الدولية" : "Experts in International Trade"}
        </h2>
        <p className="text-xl text-slate-300 max-w-2xl mx-auto">
          {ar
            ? "فريق متعدد اللغات يجمع بين الخبرة في السوق الصيني وفهم ثقافة الأعمال العالمية"
            : "Multilingual team combining expertise in the Chinese market with understanding of global business culture"}
        </p>
      </div>
        ...
        {[
          {
            ...
            name: ar ? "أحمد الصيني" : "Ahmed Al-Chini",
            role: ar ? "مدير العمليات" : "Operations Director",
            desc: ar ? "15 سنة خبرة في التجارة الصينية" : "15 years experience in China trade",
          },
          {
            image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=85",
            name: ar ? "سارة اللوجستية" : "Sarah Logistics",
            role: ar ? "مديرة الشحن" : "Shipping Manager",
            desc: ar ? "خبيرة في سلاسل الإمداد العالمية" : "Expert in global supply chains",
          },
          {
            image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&q=85",
            name: ar ? "محمد المفاوض" : "Mohammed Negotiator",
            role: ar ? "مدير التوريد" : "Sourcing Manager",
            desc: ar ? "متخصص في التفاوض مع المصانع" : "Specialist in factory negotiations",
          },
        ].map((member, index) => (
          <motion.div
            key={member.name}
          ...
          >
            ...
            <div className="relative p-6">
              ...
              <p className="text-sm font-semibold text-cyan-400 mb-2">{member.role}</p>
