...
export default function YemenPage() {
  ...
  const schema = {
    ...
    "@type": "Service",
    "name": ar ? "خدمات استيراد وشحن من الصين إلى اليمن" : "Import and Shipping Services from China to Yemen",
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 relative">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-cyan-400 font-semibold">{ar ? "اليمن" : "Yemen"}</span>
            </div>
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <h2 className="text-3xl font-black mb-12 text-center">
            {ar ? "خدماتنا لليمن" : "Our Services for Yemen"}
          </h2>
