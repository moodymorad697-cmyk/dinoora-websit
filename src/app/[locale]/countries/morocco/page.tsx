...
export default function MoroccoPage() {
  ...
  const content = ar ? {
    ...
    intro: "دينورا هي شركة عربية متخصصة في خدمات الاستيراد والشحن من الصين إلى المغرب. نفهم تماماً تحديات السوق المغربي وخصوصيته، من متطلبات الترخيص المعقدة إلى الإجراءات الجمركية في موانئ الدار البيضاء وطنجة. بعكس شركات الشحن الصينية العامة التي تقدم محتوى مترجم آلياً لكل دول العالم بنفس القالب، نحن نقدم حلولاً مخصصة تفهم الواقع المحلي المغربي.\n\nنقدم شحن البضائع من الصين إلى المغرب عبر موانئ الدار البيضاء وطنجة، وهما الموانئ الرئيسية للمغرب على المحيط الأطلسي والبحر المتوسط. خدماتنا تشمل الشحن البحري والجوي، التخليص الجمركي الكامل، التخزين المؤقت في الصين، التوريد من المصانع المباشرة، وفحص الجودة قبل الشحن. نتعامل مع جميع أنواع البضائع: الإلكترونيات، المنسوجات، المواد الخام، المواد الغذائية، والمعدات الصناعية.\n\nتتميز دينورا بفهم عميق للواقع المغربي. نحن ندرك أن المغرب له متطلبات استيراد خاصة وإجراءات تنظيمية محددة، ونحن نتعامل مع هذه التعقيدات بمرونة وخبرة. فريقنا يتحدث العربية بطلاقة ويفهم الثقافة المحلية، مما يجعل التواصل سهلاً وفعالاً. نقدم دعماً كامل من المصنع في الصين حتى باب منزلك في المغرب، مع متابعة مستمرة وتحديثات واضحة في كل مرحلة.",
    whyTitle: "لماذا تختار دينورا للمغرب؟",
    whyPoints: [
      "خبرة محلية عميقة: نفهم متطلبات الترخيص والإجراءات الجمركية المغربية، ونتعامل مع حالات القوة القاهرة بمرونة.",
      "خدمة شاملة موحدة: من التوريد والفحص في الصين حتى التسليم في المغرب، كل شيء من مكان واحد.",
      "دعم عربي متخصص: فريق عربي يتحدث لغتك ويفهم ثقافتك، بدون حواجز لغوية أو ثقافية."
    ],
    services: [
      { icon: Ship, title: "الشحن البحري عبر موانئ الدار البيضاء وطنجة", desc: "شحن بضائع من الصين إلى موانئ الدار البيضاء وطنجة بأسعار تنافسية مع متابعة كاملة" },
      { icon: Plane, title: "الشحن الجوي السريع", desc: "شحن جوي من الصين للمغرب للبضائع العاجلة مع تتبع لحظي" },
      { icon: ClipboardCheck, title: "التخليص الجمركي", desc: "إجراءات تخليص جمركي كاملة في موانئ الدار البيضاء وطنجة مع فهم متطلبات الاستيراد المغربية" },
    ...
    intro: "Dinoora is an Arab company specializing in import and shipping services from China to Morocco. We fully understand the challenges and uniqueness of the Moroccan market, from complex licensing requirements to customs procedures at Casablanca and Tangier ports. Unlike general Chinese shipping companies that offer auto-translated content for every country in the world using the same template, we provide customized solutions that understand the Moroccan local reality.\n\nWe offer shipping goods from China to Morocco via Casablanca and Tangier ports, Morocco's main ports on the Atlantic Ocean and Mediterranean Sea. Our services include sea and air shipping, full customs clearance, temporary storage in China, direct sourcing from factories, and pre-shipment quality inspection. We handle all types of goods: electronics, textiles, raw materials, food products, and industrial equipment.\n\nDinoora stands out with deep understanding of the Moroccan reality. We recognize that Morocco has specific import requirements and regulatory procedures, and we handle these complexities with flexibility and expertise. Our team speaks Arabic fluently and understands the local culture, making communication easy and effective. We provide full support from the factory in China to your doorstep in Morocco, with continuous follow-up and clear updates at every stage.",
    whyTitle: "Why Choose Dinoora for Morocco?",
    whyPoints: [
      "Deep local expertise: We understand Moroccan licensing requirements and customs procedures, and handle force majeure situations with flexibility.",
      "Unified comprehensive service: From sourcing and inspection in China to delivery in Morocco, everything from one place.",
    ...
    services: [
      { icon: Ship, title: "Sea Shipping via Casablanca and Tangier Ports", desc: "Shipping goods from China to Casablanca and Tangier ports at competitive prices with full tracking" },
      { icon: Plane, title: "Fast Air Shipping", desc: "Air shipping from China to Morocco for urgent goods with real-time tracking" },
      { icon: ClipboardCheck, title: "Customs Clearance", desc: "Full customs clearance procedures at Casablanca and Tangier ports with understanding of Moroccan import requirements" },
